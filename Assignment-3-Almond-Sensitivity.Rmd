...
## Running the almond profit model
```{r}
# Read the CSV file
...
price_per_pound_range <- seq(200, 300, by = 25)  # Create a sequence of price per pound values 
...
### Second Graph
```{r}
ggplot(results, aes(x = acre, y = profit)) +
  geom_point() +
  labs(y = "Profit (USD)", x = "Acre")
```
